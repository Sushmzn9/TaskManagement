<template>
    <div class="row">
        <div class="col-md-12">
            <div class="form-check-inline">
                <input type="radio" class="form-check-input" name="permission_type" id="inlineradio1"
                    v-model="permissionData.permission_type" value="basic">
                <label for="inlineradio1" class="form-check-label">Basic</label>
            </div>
            <div class="form-check-inline">
                <input type="radio" class="form-check-input" name="permission_type" id="inlineradio2"
                    v-model="permissionData.permission_type" value="curd">
    ...
    <div class="row" v-if="permissionData.permission_type === 'curd'">
        ...
        <div class="col-md-8 mt-4 pt-3">
            <div class="form-check-inline">
                <input type="checkbox" class="form-check-input" name="curdSelected" id="inlinecheckbox1"
                    v-model="permissionData.curdSelection" value="create">
                <label for="inlinecheckbox1" class="form-check-label">Create</label>
            </div>
            <div class="form-check-inline">
                <input type="checkbox" class="form-check-input" name="curdSelected" id="inlinecheckbox2"
                    v-model="permissionData.curdSelection" value="read">
                <label for="inlinecheckbox2" class="form-check-label">Read</label>
            </div>
            <div class="form-check-inline">
                <input type="checkbox" class="form-check-input" name="curdSelected" id="inlinecheckbox3"
                    v-model="permissionData.curdSelection" value="update">
                <label for="inlinecheckbox3" class="form-check-label">Update</label>
            </div>
            <div class="form-check-inline">
                <input type="checkbox" class="form-check-input" name="curdSelected" id="inlinecheckbox4"
                    v-model="permissionData.curdSelection" value="delete">
                <label for="inlinecheckbox4" class="form-check-label">Delete</label>
            </div>
        </div>
        <div class="row" v-if="permissionData.resource.length >= 3 && permissionData.curdSelection.length > 0 && permissionData.permission_type === 'curd' ">
            <table class="table w-100">
                ...
                <tbody>
                    <tr v-for="(item, index) in permissionData.curdSelection" :key="index">

<template>
    ...
    <div class="row" v-if="permissionData.permission_type === 'curd'">
        ...
        <div class="row" v-if="permissionData.resource.length >= 3 &&
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            <tr v-for="(
                                    item, index
                                ) in permissionData.curdSelection" :key="index">

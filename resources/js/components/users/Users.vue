        ...
        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <multi-select :options="filteredDepartments" v-model="userData.department_id"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <multi-select :options="filteredRoles" v-model="userData.selected_roles" :searchable="true"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <multi-select :options="filteredPermissionCategories" v-model="userData.selected_permission_categories
                                    " :searchable="true" mode="tags" @input="getFilteredPermission"></multi-select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="filtered_permission">
                                    Permissions
                                </label>
                                <multi-select :options="filteredPermission" v-model="userData.selected_permission"
            ...
            <div class="card">
                <div class="card-header bg-dark">
                    ...
                    <button class="btn btn-success float-right mt-2" @click="openModal">
                        New User
                    </button>
                </div>
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in getUser.data" :key="index">
...
const handleSave = () => {
    !edit.value ? storeUser() : updateUser()
}
...
function editUser(item) {
    ...
    userData.value = {
        ...
        name: item.name,
        department_id:
            item.department_id === 0 ? '' : item.department_id.toString(),
        email: item.email,
        selected_roles: [],
        selected_permission_categories: [],
        selected_permission: [],
    ...
    const permissionArray = item.permissions.map(
    ...
    store
        .dispatch('getFilteredPermission', { values: uniqueItems })
        .then(() => {
...
const filteredDepartments = computed(
    () => store.getters.filtered_departments
)
console.log(filteredDepartments)

const links = computed(() => store.getters.userLinks)
console.log(links);
